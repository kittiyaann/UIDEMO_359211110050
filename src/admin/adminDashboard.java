...
<AnchorPane prefHeight="490.0" prefWidth="790.0" xmlns="http://javafx.com/javafx/8.0.141" xmlns:fx="http://javafx.com/fxml/1" fx:controller="admin.adminController">
<children>
...
<JFXButton fx:id="btnSave" layoutX="13.0" layoutY="317.0" onAction="#saveStudent" prefHeight="25.0" prefWidth="199.0" style="-fx-background-color: #edd520;" text="Save">
<font>
<Font name="System Bold" size="12.0" />
</font>
</JFXButton>
<JFXButton fx:id="BtnEdit" layoutX="222.0" layoutY="404.0" onAction="#editStudent" prefHeight="25.0" prefWidth="89.0" style="-fx-background-color: #edd520;" text="Edit">
<font>
<Font name="System Bold" size="12.0" />
</font>
</JFXButton>
<JFXButton fx:id="btnDelete" layoutX="326.0" layoutY="404.0" onAction="#deleteStudent" prefHeight="25.0" prefWidth="89.0" style="-fx-background-color: #ed2020;" text="Delete">
<font>
<Font name="System Bold" size="12.0" />
</font>
</JFXButton>
...
<JFXButton fx:id="btnLogout" layoutX="705.0" layoutY="4.0" onAction="#logOut" prefHeight="29.0" prefWidth="84.0" text="Logout" textFill="#fc0000">
<font>
<Font name="System Bold" size="13.0" />
</font>
</JFXButton>
